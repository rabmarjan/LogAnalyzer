...
var prototype$18 = vegaUtil.inherits(Project, vegaDataflow.Transform);
...
var prototype$19 = vegaUtil.inherits(Proxy, vegaDataflow.Transform);
...
var prototype$20 = vegaUtil.inherits(Relay, vegaDataflow.Transform);
...
var prototype$21 = vegaUtil.inherits(Sample, vegaDataflow.Transform);
...
var prototype$22 = vegaUtil.inherits(Sequence, vegaDataflow.Transform);
...
var prototype$23 = vegaUtil.inherits(Sieve, vegaDataflow.Transform);
...
var prototype$24 = vegaUtil.inherits(TupleIndex, vegaDataflow.Transform);
...
var prototype$25 = vegaUtil.inherits(Values, vegaDataflow.Transform);
...
var prototype$27 = WindowState.prototype;

prototype$27.init = function() {
  this.windows.forEach(function(_) { _.init(); });
  if (this.cell) this.cell.init();
};

prototype$27.update = function(w, t) {
  var self = this,
      cell = self.cell,
      wind = self.windows,
      data = w.data,
...
var prototype$26 = vegaUtil.inherits(Window, vegaDataflow.Transform);
...
prototype$26.group = function(key$$1) {
  var self = this,
