...
var TooltipTrigger = exports.TooltipTrigger = function (_React$Component) {
  ...
  TooltipTrigger.prototype.clickHandler = function clickHandler() {
    var _this3 = this;
  ...
  TooltipTrigger.prototype.render = function render() {
    var _props2 = this.props,
        ...
        theme = _props2.theme,
        size = _props2.size,
        others = (0, _objectWithoutProperties3.default)(_props2, ['isSticky', 'placement', 'tooltip', 'trigger', 'className', 'clickHideDelay', 'onEntered', 'onExited', 'theme', 'size']);
